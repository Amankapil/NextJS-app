  ...
  return (
    <>
      {width <= 900 ? (
        ...
        // desktop
        <div className='bg-[#fff] max--[1400px] mx-auto flex gap-5 justify-between items-center w-full text-base font-medium leading-4 text-center text-[#000] max-md:flex-wrap max-md:max-w-full py-6 px-10 wfull mxauto sticky top-0 h[100px] roundedfull z-[9999999999999999990] '>
          <Link href='/'>
            <div className='logobg'></div>
          </Link>
