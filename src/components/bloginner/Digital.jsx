...
const Digital = () => {
  return (
    <>
      <div className='w-full h-[2526px] relative bg-white max-md:h-[3400px]'>
        ...
        <Image
          className='w-[50%] max-lg:w-full max-lg: max-lg:left-2 h-[490.08px] left-[150.62px] top-[456.12px] absolute rounded-[21.75px] max-md:mt-24 max-md:p-4'
          src={img}
          alt=''
        />
        ...
        <div className='h-[1958px] max-md:h-full left-[154px] top-[1033.50px] absolute flex-col justify-start items-start gap-[35px] inline-flex max-md:left-0 max-md:w-full max-xl:h-full  max-md:p-4'>
